...
requests = pd.read_excel('data/sample_requests_small.xlsx')
requests = requests.sort_values('requested_at')
requests['index'] = np.arange(len(requests))
contracts = pd.read_excel('data/sample_contracts_small.xlsx')
configured_tanker = pd.read_excel('data/configured_tanker_sample_small.xlsx')
flight_times = pd.read_excel('data/sample_flight_times_small.xlsx')
compatibility = pd.read_excel('data/compatibility_sample_small.xlsx')
contract_compatibility = pd.read_excel('data/j_contract_configured_tanker_sample_small.xlsx')
