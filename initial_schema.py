...
for p in paths:
    ...
    #     transit_time = flight_times[destinations[p[0]][destinations[p[1]]]
    #     time_between = (requests['requested_at'][int(requests['index'][requests['id']==p[1]])] - requests['requested_at'][int(requests['index'][requests['id']==p[0]])]).seconds/60.
    #     if time_between >= transit_time:
    #         edges.append(p)
    #         edge_times.append(time_between)
    # elif p[0] not in requests['id'] and p[1] in requests['id']:
    #     edges.append(p)
    #     edge_times.append(flight_times[destinations[p[0]]][destinations[p[1]]])
    # elif p[0] in requests['id'] and p[1] not in requests['id']:
    #     edges.append(p)
    #     edge_times.append(flight_times[destinations[int(requests['index'][requests['id']==p[0]])]][destinations[p[1]]])
